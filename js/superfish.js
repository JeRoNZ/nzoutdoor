...
$(this).find('>span').stop().animate({height:0,left:'50%',width:0});return this},showSuperfishUl:function(){var o=sf.op,$ul=this.addClass(o.hoverClass).find('>ul:hidden');$ul.animate(o.animation,o.speed);return this}})})(jQuery);
$(function(){
	$('.sf-menu').superfish().find('>li').not('.current').append('<span></span>')
	.hover(
		function(){
			$(this).find('>span').stop().animate({height:'100%',left:0,width:'100%'})
		},
		function(){
			if($(this).hasClass('sfHover'))return
			else $(this).find('>span').stop().animate({height:0,left:'50%',width:0})
		}
	)
})