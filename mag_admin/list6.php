...
function do_extract(){
    global $mysqli;
    $sql="select * from sub_subscribers where free='Y'";
    ...
    header('Content-disposition: attachment; filename="Complimentary_list.csv"');
...
echo HTMLSTART.page_header().'<h1>Complimentary List</h1>'.do_form().page_footer().HTMLEND;
?>
</body>
</html>
