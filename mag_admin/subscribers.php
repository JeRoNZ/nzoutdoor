...
<input type="submit" name="action" value="New" title="Add new subscriber">
<input type="submit" name="action" value="Quit" title="Quit subscriber maintenance">
</form>
...
<td>[CITY]</td>
<td>[REGION]</td>
<td><img src="/images/flags/32/[COUNTRY].png" alt="flag"></td>
<td>[EMAIL]</td>
<td>[PHONE]</td>
<td>[FIRST]</td>
<td>[LAST]</td>
...
<button name=edit value=Edit title="Edit Subscriber"><img src="/images/Edit.png"></button>
